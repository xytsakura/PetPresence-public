...
PetPresence 起源于一次黑客松项目，由 `xytsakura` 作为队长推进，并由 `fhx020826`、`KKqdtjo`、`de2-a`、`liam-harrison1`、`zhu-zhu666`、`Wyh-max-star`、`zhujiandong`、`LvShaoran` 共同参与协作。
...
<p align="center">
  <img src="docs/images/creator-pipeline-workflow.svg" alt="PetPresence creator pipeline 工作流程图" width="920" />
</p>

## Demo 预览

<p align="center">
  <img src="docs/images/bichon-demo-idle.png" alt="小白 idle 桌宠动画" width="220" />
  <img src="docs/images/bichon-demo-play.png" alt="小白 play 桌宠动画" width="220" />
  <img src="docs/images/bichon-demo-sleep.png" alt="小白 sleep 桌宠动画" width="220" />
</p>
