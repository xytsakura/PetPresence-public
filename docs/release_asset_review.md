...
- lightweight transparent APNG previews generated from the approved `pet_bichon_demo` WebM runtime assets.
...
docs/images/bichon-demo-idle.png
docs/images/bichon-demo-play.png
docs/images/bichon-demo-sleep.png
```
